...
function SalesChart({ bookings, numDays }) {
  ...
  // Explanation for below: first allDates gives the total bookings for 7,30and 90 days. and we need to filter out the bookings for each day, so filter using the isSameDay
      ...
      <ResponsiveContainer height={300} width="100%">
        <AreaChart data={data}>
          ...
          <Area
            ...
            strokeWidth={3} // its the graph line width
            name="Total Sales"
            unit="₹"
          />
          <Area
